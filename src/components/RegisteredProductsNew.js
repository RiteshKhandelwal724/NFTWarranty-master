...
import { productListFromBC } from "../endpoints";
...
const RegisteredProducts = () => {
  ...
  const [productsArray, setProductsArray] = useState([
    { productSerialNumber: "1111", tokenId: "11" },
  ]);
    ...
    const getDataFun = async () => {
      ...
      try {
        if (res?.statusCode === "200") {
          console.log("response", res);
          setProductsArray([...productsArray, ...res?.productList]);
        ...
        return (
          ...
          >
            <AccordionSummary
              ...
              onClick={() => {
                console.log("data", productDetails?.tokenId);
              }}
            >
